          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="POST" action="">
                ...
                <div class="mb-3">
                    <label class="form-label" for="estado">Rol</label>
            ...
            <div class="tile-footer">
              <button class="btn btn-primary" onclick="addUser()" type="button"><i class="bi bi-check-circle-fill me-3"></i>Register</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="#"><i class="bi bi-x-circle-fill me-3"></i>Cancel</a>
            </div>
          </div>
        </div>
      </div>
